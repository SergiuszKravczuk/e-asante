...
import { selectCartProducts } from "@/app/GlobalRedux/CartSlice/CartSlice";
...
const CartDropDown = () => {
  ...
  return (
    <section
      className={`fixed right-[0] top-[0] max-w-xs min-w-[300px] bg-white h-[100vh] z-20 overflow-y-scroll`}
    >
      <header>
      ...
      {products.length > 0 ? (
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="font-philosopher tracking-wider mb-4">
            Masz już konto?
          </p>
